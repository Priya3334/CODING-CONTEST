...
export default function Content(){
    return(
        <div>
        <p>Victoria Furnitures Ltd is one of the leading suppliers of
        ...
        technology to work with Corian® material as well as other
        ...
        furniture</p>
        <div id="table"><img src="https://tse4.mm.bing.net/th?id=OIP.k3POflkbnZZfIHjhFFmLhwHaE8&pid=Api&P=0"></img></div>
        </div>
    )
}